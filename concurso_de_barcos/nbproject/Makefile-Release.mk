...
${OBJECTDIR}/_ext/233601340/jugador1.o: ../Concurso_de_barcos/jugador1.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/233601340/jugador1.o ../Concurso_de_barcos/jugador1.cpp

${OBJECTDIR}/_ext/233601340/clases.o: ../Concurso_de_barcos/clases.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/233601340
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/233601340/clases.o ../Concurso_de_barcos/clases.cpp

${OBJECTDIR}/_ext/233601340/humano.o: ../Concurso_de_barcos/humano.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/233601340
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/233601340/humano.o ../Concurso_de_barcos/humano.cpp

${OBJECTDIR}/_ext/233601340/barcos.o: ../Concurso_de_barcos/barcos.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/233601340
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/233601340/barcos.o ../Concurso_de_barcos/barcos.cpp
